                    ...
                    @csrf
                        <table class="col-7 table table-borderless"> 
                            <tr>
                                <td>ID Motor</td>
                                <td>:</td>
                                <td><input type="text" name="idmotor" placeholder="Masukkan ID Motor"/></td>
                            </tr>
                            <tr>
                                <td>Harga Promo</td>
                                <td>:</td>
                                <td><input type="text" name="hargaPromo" placeholder="Masukkan Harga Promo"/></td>
                            </tr>                          
                            <tr>
                            <td></td>
                            <td></td>
                            <td>
                                <input type="submit" value="Edit" class="btn-lg btn-primary" />  
